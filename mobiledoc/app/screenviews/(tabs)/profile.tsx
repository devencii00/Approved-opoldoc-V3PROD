  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>Personal details and account tools will live here.</Text>
      </View>

      <ScrollView style={styles.scroll} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.card}>
          <View style={styles.iconWrap}>
            <Ionicons name="person-outline" size={24} color={T.cyan700} />
          </View>
          <Text style={styles.cardTitle}>Profile tab ready</Text>
          <Text style={styles.cardText}>
            This uses the same mobile theme so the bottom navigation can now show Profile as a real tab.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
